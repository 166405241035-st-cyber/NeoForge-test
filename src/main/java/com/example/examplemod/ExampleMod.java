...
public class ExampleMod {
    ...
    public static final DeferredBlock<Block> FORGING_BLOCK = BLOCKS.register("forging_block",
    ...
    public static final DeferredBlock<Block> FORGING_ANVIL = BLOCKS.register("forging_anvil",
            registryName -> new ForgingAnvilBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(5.0F)));
    public static final DeferredItem<BlockItem> FORGING_ANVIL_ITEM = ITEMS.registerSimpleBlockItem("forging_anvil", FORGING_ANVIL);

    public static final DeferredHolder<MenuType<?>, MenuType<ForgeMenu>> FORGE_MENU = MENUS.register("forge_menu",
            () -> IMenuTypeExtension.create((windowId, inventory, data) -> new ForgeMenu(windowId, inventory)));
    ...
    public static final DeferredItem<ForgedHeadItem> FORGED_HEAD_ITEM = ITEMS.register("forged_head",
            registryName -> new ForgedHeadItem(new Item.Properties().stacksTo(1)));
    public static final DeferredItem<ForgedCoreItem> FORGED_CORE_ITEM = ITEMS.register("forged_core",
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            ...
            .icon(() -> FORGING_BLOCK_ITEM.get().getDefaultInstance()).displayItems((parameters, output) -> {
                ...
                output.accept(SWORD_HEAD_BLUEPRINT.get()); output.accept(AXE_HEAD_BLUEPRINT.get());
                output.accept(PICKAXE_HEAD_BLUEPRINT.get()); output.accept(SHOVEL_HEAD_BLUEPRINT.get());
                output.accept(HOE_HEAD_BLUEPRINT.get()); output.accept(CORE_BLUEPRINT.get()); output.accept(ROD_BLUEPRINT.get());
                output.accept(FORGED_HEAD_ITEM.get()); output.accept(FORGED_CORE_ITEM.get());
            }).build());
