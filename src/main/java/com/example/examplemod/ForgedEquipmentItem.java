...
public class ForgedEquipmentItem extends Item {
    public ForgedEquipmentItem(Properties properties) {
        super(properties);
    }

    public ItemStack createStack(AnvilAssemblyResult assembly, MonsterMaterial headMaterial,
                                 MonsterMaterial coreMaterial, MonsterMaterial rodMaterial) {
        ...
        stack.set(DataComponents.CUSTOM_NAME, Component.literal(
                equipmentName(assembly.blueprint()) + " " + shortName(headMaterial) + "+" +
                        shortName(coreMaterial) + "+" + shortName(rodMaterial)));
        return stack;
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (head != null && core != null && rod != null) {
            tooltip.add(Component.literal(displayName(head) + " + " + displayName(core) + " + " + displayName(rod))
    ...
    private static MonsterMaterial readMaterial(String value) {
        try { return MonsterMaterial.valueOf(value); }
        catch (IllegalArgumentException ex) { return null; }
    }

    private static String equipmentName(HeadBlueprintType type) {
        return switch (type) {
            case SWORD -> "Sword";
            case AXE -> "Axe";
    ...
    private static String shortName(MonsterMaterial material) {
        return switch (material) {
            case ROTTEN_FLESH -> "Ro";
            case BONE -> "Bo";
            case STRING -> "St";
            case GUNPOWDER -> "Gu";
            case SLIME -> "Sl";
            ...
            case WITHER -> "Wi";
            case PHANTOM -> "Ph";
            case DRAGON_BREATH -> "Dr";
            case SHULKER -> "Sh";
            case NETHER_STAR -> "Ne";
        };
    }

    private static String displayName(MonsterMaterial material) {
