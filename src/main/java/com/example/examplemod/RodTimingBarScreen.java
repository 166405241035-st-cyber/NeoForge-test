...
public class RodTimingBarScreen extends Screen {
    ...
    private static final float PERFECT_RATIO = 0.20F, GREAT_RATIO = 0.55F;
    private static final int GOOD_ZONE_COLOR = 0xFFFFCC33, GREAT_ZONE_COLOR = 0xFF22AA44, PERFECT_ZONE_COLOR = 0xFF66FF66;
    ...
    private static String formatName(String value) {
        String[] words = value.toLowerCase().split("_"); StringBuilder builder = new StringBuilder();
        for (String word : words) { if (!builder.isEmpty()) builder.append(' '); builder.append(Character.toUpperCase(word.charAt(0))).append(word.substring(1)); }
